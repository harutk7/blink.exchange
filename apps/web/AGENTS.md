...
## Web Validation
- Type check web app changes: `pnpm --filter @blink/exchange-web check`
- Run unit tests when relevant: `pnpm --filter @blink/exchange-web test:unit`
- Run e2e tests for user flow changes: `pnpm --filter @blink/exchange-web test`
