  ...
  return (
    ...
    >
      <InfoCard
        ...
        href="https://blink-landing.apps.levarqo.com/blade/introduction/how-lps-earn-from-arbitrage"
      />
      <InfoCard
        ...
        href="https://blink-landing.apps.levarqo.com/blade/introduction/blades-benchmark-no-impermanent-loss"
      />
      <InfoCard
        title="MEV-Proof"
        description={`Your yield is profit-based. Blade generates LP yields by making smart trades, not by charging fees while disguising your losses as "impermanent."`}
        ...
        glowClassName="bg-[#B3EDFE]"
        href="https://blink-landing.apps.levarqo.com/blade/introduction/how-blade-makes-money-for-lps#fmm-architecture"
      />
    </div>
  )
}
