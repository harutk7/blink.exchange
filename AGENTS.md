...
## Purpose
This monorepo contains the BLINK Exchange interface and shared packages used
across apps, config, and tooling. Agent changes should prioritize correctness,
